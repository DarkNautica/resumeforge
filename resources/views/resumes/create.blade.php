<x-app-layout>
    ...
    <div class="py-10">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <form method="POST" action="{{ route('resumes.store') }}" x-data="resumeForm()" class="space-y-8">
                @csrf
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 space-y-5">
                    ...
                    <div>
                        ...
                        <input type="text" name="title" value="{{ old('title') }}" placeholder="e.g. Senior Developer Resume"
                    ...
                    <div>
                        ...
                        <textarea name="summary" rows="4" placeholder="A brief professional summary..."
                            class="w-full border border-gray-300 rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500">{{ old('summary') }}</textarea>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 space-y-4">
                    ...
                    <template x-for="(job, index) in jobs" :key="index">
                        <div class="border border-gray-200 rounded-md p-4 space-y-3 relative">
                            ...
                            <input type="hidden" :name="`work_experience[${index}][id]`" :value="job.id">
